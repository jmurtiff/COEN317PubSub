...
#The proxy_count will let us randomly select a proxy node to use for encryption + decryption
proxy_ip = None
proxy_port = None
proxy_node_count = 0
...
# first, after broker and proxy node(s) have been created, get the proxy nodes' information
get_proxy_nodes()
